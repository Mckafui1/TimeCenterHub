...
export const TOOLS: Tool[] = [
  ...
  { id: 'time-in-decimal', path: '/time-to-decimal', name: 'Time to Decimal Converter', description: '8:30 to 8.5 hours.', category: 'Time', longDescription: 'Convert hours and minutes (8:30) into decimal hours (8.5). Essential for payroll, billing, and timesheet calculations in professional settings.', faqs: [], examples: [] },
