            ...
            <div className="col-span-1 md:col-span-2 space-y-6 md:space-y-8 flex flex-col items-center md:items-start">
              ...
              <div className="pt-4">
                 ...
                 <div className="flex items-center gap-4">
                    <a href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(shareText)}&url=${encodeURIComponent(shareUrl)}`} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-slate-100 rounded-full flex items-center justify-center text-slate-600 hover:bg-blue-400 hover:text-white transition-colors" aria-label="Share on Twitter">
